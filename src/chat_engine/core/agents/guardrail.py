...
class GuardrailOutput(BaseModel):
    """Model output for guardrail checks, indicating whether the query is blocked and the reason for blocking if applicable."""
        ...
        try:
            ...
            if result.blocked:
                ...
                if not result.suggestions:
                    suggestions = "Please rephrase your question so that it complies with the general content guidelines and avoids offensive, unethical or harmful content."
                else:
            ...
            return {"blocked": True, "reason": "An error occurred during content moderation checks. Please try again later."}